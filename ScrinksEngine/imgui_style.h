...
namespace scrinks::gui
{
	...
	void set_style_large_mat_blue()
	{
		...
		style.FramePadding = ImVec2(7.5f, 5.099999904632568f);
		...
		style.Colors[ImGuiCol_Text] = ImVec4(0.8873620629310608f, 0.9020186066627502f, 0.9313304424285889f, 1.0f);
		...
		style.Colors[ImGuiCol_Border] = ImVec4(0.08587375283241272f, 0.1131543219089508f, 0.1587982773780823f, 1.0f);
		...
		style.Colors[ImGuiCol_Button] = ImVec4(0.0f, 0.3282801508903503f, 0.5708154439926147f, 1.0f);
		style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.252647876739502f, 0.4434111416339874f, 0.545064389705658f, 1.0f);
		...
		style.Colors[ImGuiCol_TabActive] = ImVec4(0.0f, 0.3282801508903503f, 0.5708154439926147f, 1.0f);
		style.Colors[ImGuiCol_TabUnfocused] = ImVec4(0.1529411822557449f, 0.1725490242242813f, 0.2117647081613541f, 1.0f);
		style.Colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.1843835711479187f, 0.2319836020469666f, 0.278969943523407f, 1.0f);
		style.Colors[ImGuiCol_PlotLines] = ImVec4(0.6078431606292725f, 0.6078431606292725f, 0.6078431606292725f, 1.0f);
		style.Colors[ImGuiCol_PlotLinesHovered] = ImVec4(1.0f, 0.4274509847164154f, 0.3490196168422699f, 1.0f);
		style.Colors[ImGuiCol_PlotHistogram] = ImVec4(0.0f, 0.8980392217636108f, 0.4702179133892059f, 1.0f);
